...
import { ShoppingCart, LogOut, Printer, PlusCircle, Package } from 'lucide-react'; 
            ...
            {isAuthenticated && user ? (
              ...
              <Dropdown align="end">
                ...
                <Dropdown.Menu className="shadow-lg border-0 rounded-3 p-2 mt-2" style={{ minWidth: '220px' }}>
                  ...
                  {user.role === 'admin' && (
                    <>
                      ...
                      <Dropdown.Item as={Link} to="/admin/create-product" className="d-flex align-items-center gap-2">
                        <PlusCircle size={16} className="text-primary" /> Crear Producto/Servicio
                      </Dropdown.Item>
                      <Dropdown.Divider />
                    </>
                  )}
                  ...
                  <Dropdown.Header className="fw-bold small text-muted">MI CUENTA</Dropdown.Header>
                  <Dropdown.Item as={Link} to="/profile" className="d-flex align-items-center gap-2">
                    <UserIconFallback /> Mi Perfil
                  </Dropdown.Item>
                  <Dropdown.Item as={Link} to="/orders" className="d-flex align-items-center gap-2">
...
// Pequeño componente auxiliar para el icono de usuario si no quieres importar User de lucide
